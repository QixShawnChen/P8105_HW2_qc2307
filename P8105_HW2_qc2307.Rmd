...
The dataset `wheel_data_rounded` is generated after doing data clean and rounding `sports_balls` variable.
...
`r sum(precipitation_2018$total)`. The median precipitation in 2019 is `r median(precipitation_2019$total)`.
